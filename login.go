...
func main() {
	...
	getCaptchaPic("https://cas.sysu.edu.cn/cas/captcha.jsp")
	...
	login("https://cas.sysu.edu.cn/cas/login?service=https%3A%2F%2Fuems.sysu.edu.cn%2Fjwxt%2Fapi%2Fsso%2Fcas%2Flogin%3Fpattern%3Dstudent-login", token)
	// getCourseList("https://uems.sysu.edu.cn/jwxt/choose-course-front-server/classCourseInfo/selectCourseInfo?_t=1547712166")

}

func getCaptchaPic(url string) {
...
func login(loginURL string, token string) {
	...
	req.Header.Set("origin", "https://uems.sysu.edu.cn")
	req.Header.Set("host", "uems.sysu.edu.cn")
